...
def main():
    ...
    CONFIG = {
        ...
        'images_dir': '/home/ubuntu/floorplan_classifier/VpC3/Unet_plus_plus/data/processed/images',
        #'masks_dir': 'data/processed/annotations',
        'masks_dir': '/home/ubuntu/floorplan_classifier/VpC3/Unet_plus_plus/data/processed/annotations',
        'batch_size': 8,
